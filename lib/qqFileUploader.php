    ...
    public function handleUpload($uploadDirectory, $name = null){
        ...
        if ($this->toBytes(ini_get('post_max_size')) < $this->sizeLimit ||
            ...
            return array('error'=>"Server error. Increase post_max_size and upload_max_filesize to ".$size
            	." post_max_size=" . $this->toBytes(ini_get('post_max_size'))
            	.", upload_max_filesize=" . $this->toBytes(ini_get('upload_max_filesize'))
            	.", sizeLimit=" . $this->sizeLimit
            	);
        }

        if (!is_writable($uploadDirectory) || 
        		(strtoupper(substr(PHP_OS, 0, 3)) !== 'WIN') && !is_executable($uploadDirectory)){
